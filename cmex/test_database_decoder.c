        ...
        case CMMC_MSG1_FRAME_ID:
            {
                ...
                static const char *signal_names[4] = {
                    CMMC_MSG1_SPEED_NAME,
                    CMMC_MSG1_ACCELERATION_NAME,
                ...
                *nsignals_ptr = 4;
                *frame_name_ptr = CMMC_MSG1_NAME;
                return 0;
            }
        case CMMC_MSG2_FRAME_ID:
            {
                /* Unpack data into temporary structure */
